...
do
        ...
        then
                ...
                timeout 1.5m ${movie_soft_path}/motioncorr_v2.1 ${file} -fod 2 -ssc $ssc1 -fct aligned_movies_motioncorr/${stack}_movie.mrcs -fcs aligned_sums_motioncorr/${stack}.mrc -dsp 0 -atm 1 -flg logs/alignment/${stack}_align_motioncorr.log &>/dev/null
